...
public class Multiples implements Cloneable
{
   ...
   public void add(Multiples mult)
   {
      ...
      total += first == -1 ? num1 : num1*Integer.parseInt(values.get(first).getValue());
      total += second == -1 ? num2 : num2*Integer.parseInt(mult.values.get(second).getValue());
