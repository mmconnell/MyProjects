...
public class MatrixManager
{
   ...
   private boolean scaleRow(String str)
   {
      ...
      AdditiveFraction fracOne = inputManagement.interpretAdditiveFraction(fracStr);
      if(fracOne == null)
      {
         printError();
         return true;
   ...
   private boolean subtractTwoRows(String str)
   {
      ...
      AdditiveFraction frac1 = inputManagement.interpretAdditiveFraction(scale1);
      AdditiveFraction frac2 = inputManagement.interpretAdditiveFraction(scale2);
      if(frac1 == null || frac2 == null)
      {
         printError();
         return true;
      }
      frac2.multiply(inputManagement.interpretAdditiveFraction("-1"));
   ...
   private boolean scaleMatrix(String str)
   {
      ...
      AdditiveFraction additiveFraction = inputManagement.interpretAdditiveFraction(str.substring(0, str.indexOf('m')));

      if(additiveFraction == null)
      {
         printError();
         return true;
      }
      ...
      try
      {
         matrix.scaleMatrix(additiveFraction, operations.get(matrices.indexOf(matrix)), forwardOperations.get(matrices.indexOf(matrix)));
      }
      catch(IllegalArgumentException e)
      {
         System.out.println(e.getMessage());
   ...
   private boolean multiplyMatrix(String str)
   {
      ...
      AdditiveFraction scale1 = inputManagement.interpretAdditiveFraction(str.substring(0,str.indexOf('m')));
      AdditiveFraction scale2 = inputManagement.interpretAdditiveFraction(str.substring(str.indexOf('x')+1, str.lastIndexOf('m')));
   ...
   private boolean subtractTwoMatrices(String str)
   {
      ...
      AdditiveFraction scale1 = inputManagement.interpretAdditiveFraction(str.substring(0,str.indexOf('m')));
      AdditiveFraction scale2 = inputManagement.interpretAdditiveFraction(str.substring(str.indexOf('-')+1, str.lastIndexOf('m')));
      scale2.multiply(inputManagement.interpretAdditiveFraction("-1"));
   ...
   private boolean addMatrix(String str)
   {
      ...
      for(String rows: strings)
      {
         ...
         while(kb.hasNext())
         {
            temp = inputManagement.interpretAdditiveFraction(kb.next());
            if(temp == null)
            {
               printError();
               return true;
